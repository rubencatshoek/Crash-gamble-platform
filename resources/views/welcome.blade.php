...
@section('content')
    <div class="background-main text-white hero-background">
        ...
        <div class="container-fluid hero-padding">
            <div class="row">
                <div class="col-md-6 padding-left-15">
                    ...
                    <h1 class="landing-page-header text-responsive">The New Name in Cryptocurrency
                        Gambling</h1>
                    ...
                    <div class="pt-3">
                        <a class="my-1 px-5 btn background-brand btn-lg text-white" href="{{ route('play.index') }}">Play
                            now</a>
                        <a class="my-1 btn btn-outline-light btn-lg px-5" href="#learn-more">
                            Learn more
                        </a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12 pb-5">
                        <img alt="crash gif" height="600px" width="600px" class="img-fluid d-none d-sm-none d-md-block"
                ...
                <div class="col-lg-6 text-center">
                    ...
                    <table class="table-landing table text-white background-secondary border-0">
                        ...
                        @for($i = 1; $i <= 5; $i++)
                            <tr>
                                <td id="rankId{{ $i }}">#{{ $i }}</td>
                                <td id="userId{{ $i }}"><img class="img-fluid" alt="loading" height="20px" width="20px"
                                                             src="{{ asset('img/load.svg') }}"></td>
                                <td id="profitId{{ $i }}" class="color-green"><img class="img-fluid" alt="loading"
                                                                                   height="20px" width="20px"
                                                                                   src="{{ asset('img/load.svg') }}">
                                </td>
                            </tr>
                        @endfor
                        </tbody>
                ...
                <div class="col-lg-6 text-center">
                    ...
                    <table class="table-landing table text-white background-secondary border-0">
                        ...
                        @for($j = 1; $j <= 5; $j++)
                            <tr>
                                <td id="rankId{{ $j }}">#{{ $j }}</td>
                                <td id="squadId{{ $j }}"><img class="img-fluid" alt="loading" height="20px" width="20px"
                                                              src="{{ asset('img/load.svg') }}"></td>
                                <td id="squadProfitId{{ $j }}" class="color-green"><img class="img-fluid" alt="loading"
                                                                                        height="20px" width="20px"
                                                                                        src="{{ asset('img/load.svg') }}">
                                </td>
                            </tr>
